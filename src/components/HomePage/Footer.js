...
export default function Footer() {
    ...
    return (
        <div
            ...
            className="text-[32px] sm:w-[425px] md:w-full md:border-none border-t-2 pt-[100px] bottom-[-46rem] md:bottom-[-84rem] ip:w-[425px] md:bg-[url('https://cdn.shopify.com/s/files/1/0434/2520/2335/files/footer-bg.jpg?v=1614290780')] lg:h-[422px] relative  bg-center h-[382px] md:h-[356px] bg-cover"
        >
