                ...
                <div className={`${animate == "translate-x-[44px]" ? " flex-col gap-0" : "md:flex-row "} flex-col flex-wrap md:gap-[25px] xl:gap-[27px] mt-[24px] relative flex`}>
                    {!isLoading ?
                        currenCart?.map((product) => (
                            ...
                            <div key={product.id} className='boder relative rounded-[4px] pb-4  w-full lg:w-[245px] lg:h-[471px] flex flex-col justify-between group/item overflow-hidden items-center'>
