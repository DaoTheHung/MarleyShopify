...
export default function Description() {
    return (
        <div className='leading-[41px] flex flex-col gap-[13px]'>
            <p className='ip:w-full md:w-[1061px] text-[22px] text-ink-100'> Nam tempus turpis at metus scelerisque placerat nulla deumantos solicitud felis. Pellentesque diam dolor, elementum etos lobortis des mollis ut risus. Sedcus faucibus an sullamcorper mattis drostique des commodo pharetras loremos.Donec pretium egestas sapien et mollis.</p>

            <h3 className='text-[23px] text-ink-100'>
                Lorem ipsum dolor sit amet
            </h3>

            <p className='ip:w-full w-[1121px] text-[22px] text-ink-100'>  Sonsectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>

            <h3 className='text-[23px] text-ink-100'>
                Busey ipsum dolor sit amet
            </h3>

            <p className='ip:w-full w-[1137px] text-[22px] text-ink-100'>
