...
export default function LearnMore() {
    return (
        ...
        <div className="md:bg-[url('https://cdn.shopify.com/s/files/1/0434/2520/2335/files/wide-banner_362654f3-dcb6-46e3-88a4-0ed839703d2b.jpg?v=1631093376')] bg-[#ef6d9f8a] relative sm:w-[425px] md:w-full h-[653px] md:h-[850px] top-[437px] md:top-[705px]  bg-cover">
