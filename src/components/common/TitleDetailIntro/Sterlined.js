...
export default function Sterlined() {
    return (
        <div>
            <div className='relative lg:m-auto lg:w-[1325px] sm:w-[408px] md:w-[1097px] bottom-[-37rem] md:bottom-[-67rem] md:mb-[190px] md:ml-[136px] lg::ml-[195px] md:mr-[245px] '>
                <div className='ml-[60px]'>
                    <div className=' md:w-[35px] md:h-[6px] w-[26px] h-[5px]  rounded-[5px] bg-pink-500'></div>
                    <h3 className='cursor: default w-[259px]  md:w-[512px] text-[#1a1a1a] text-[39px]  md:text-[40px] font-bold leading-[66px] tracking-[3px] mt-[21px] mb-[72px]'>
                        Sterlined Headphone
                        Style 2021
                    </h3>
                </div>
                ...
                <div className='flex flex-col-reverse md:ml-[63px] md:w-full lg:w-[1132px] lg:ml-[50px] md:flex-row-reverse justify-between'>
                    <div className='md:w-[439px] mt-[53px] '>
                        <div className='flex flex-col gap-[44px] md:ml-auto ml-[60px]'>
                            ...
                            <p className=' text-[#9e9999]  text-[20px] lg:text-[22px] md:text-[21px] w-[306px] md:w-full lg:w-[467px] leading-[40px]'>
                    ...
                    <div className='md:w-[614px] lg:w-[614px] ip:w-[252px] lg:ml-0 md:ml-0 ip:ml-[60px]'>
